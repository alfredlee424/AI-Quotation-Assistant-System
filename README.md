...
> 我要 1 張 60*180 的桌子，桌面用 25mm MDF，胡桃色紙，45寬木腳。
...
標準範例（`qty=1`，A001 選 C003=60*180，B001 選 C001=45寬環式腳）：

```text
CMT1\A001\S004       板材 stdqty=4.5 × $700  = $3,150
CMT1\A001\S005\S001  色紙 stdqty=1.0 × $513  =   $513
CMT1\A001\W001\W010  裁切 stdqty=1.0 × $150  =   $150
CMT1\A001\W001\W030  木工 stdqty=1.0 × $300  =   $300
CMT1\B001\S004       腳板 stdqty=8.0 × $480  = $3,840
CMT1\B001\S005\S008  色紙 stdqty=4.0 × $140  =   $560
                     材料成本小計              $8,513
                     × 加成 30% × 稅 5%      $11,620（最終報價）
```

> **ordqty 查詢規則（已驗證）**：子部件 stdqty 以「驅動根節點所選代碼」查詢，
> 而非子部件自身代碼。例如 `CMT1\A001\S004` 的 stdqty，
> 用 A001 所選尺寸代碼（C003=60*180）查 ordqty，得 stdqty=4.5。
